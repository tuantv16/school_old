...
<html lang="en">
  ...
  <script src="{{ asset('ckeditor/ckeditor.js') }}"></script>
    ...
    <main class="app-content">
      ...
      <!-- Tuấn Master layout - Begin-->
      @yield('content')
      
      <!-- Tuấn Master layout - End -->
      
    </main>
    <!-- Essential javascripts for application to work-->
   <!--  <script type="text/javascript" src="{{ asset('js/backend/jquery-3.3.1.min.js') }}"></script>
    ...
    <script type="text/javascript" src="{{ asset('js/backend/plugins/pace.min.js') }}"></script> -->
