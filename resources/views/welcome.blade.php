        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarsExampleDefault">
                ...
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle" href="#" id="dropdown01" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Tổ chức</a>
                    <div class="dropdown-menu" aria-labelledby="dropdown01">
                        <a class="dropdown-item" href="#">Chi bộ đảng</a>
                        <a class="dropdown-item" href="#">Ban giám hiệu</a>
                        <a class="dropdown-item" href="#">Ban chấp hành công đoàn</a>
                        <a class="dropdown-item" href="#">Đoàn thanh niên cộng sản HCM</a>
                        <a class="dropdown-item" href="#">Công đoàn</a>
                    </div>
                </li>
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle" href="#" id="dropdown01" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Văn bản</a>
                    <div class="dropdown-menu" aria-labelledby="dropdown01">
                        <a class="dropdown-item" href="#">Văn bản của Bộ giáo dục</a>
                        <a class="dropdown-item" href="#">Văn bản của Sở giáo dục</a>
                        <a class="dropdown-item" href="#">Văn bản của trường</a>
                    </div>
                </li>
                <li class="nav-item">
                ...
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle" href="#" id="dropdown01" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Tra cứu</a>
                    <div class="dropdown-menu" aria-labelledby="dropdown01">
                      <a class="dropdown-item" href="#">Kết quả kỳ thi học kì I năm 2020</a>
                      <a class="dropdown-item" href="#">Kết quả kỳ thi học kì II năm 2020</a>
                      <a class="dropdown-item" href="#">Something else here</a>
                    </div>
                </li>
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle" href="#" id="dropdown01" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Dropdown2</a>
                    <div class="dropdown-menu" aria-labelledby="dropdown01">
                      <a class="dropdown-item" href="#">ten</a>
                      <a class="dropdown-item" href="#">dfs action</a>
                      <a class="dropdown-item" href="#">vcccc else here</a>
                    </div>
                </li>
                </ul>
            </div>
...
<main role="main">
  ...
  <div class="container">
    <!-- Example row of columns -->
        ...
        ?>
        <div class="row slideanim bg-white ar">
            <div class="col-md-3 ">
        ...
        <section class="area_header sec01">
         <div class="row slideanim bg-white">
         <!-- left -->
...
Phát biểu tại buổi lễ, Bộ trưởng Bộ GD&ĐT Phùng Xuân Nhạ cho biết: Thời gian qua, Chỉ thị 05 của Bộ Chính trị đã được thực hiện sâu rộng trong toàn ngành Giáo dục, đạt nhiều kết quả quan trọng. Bộ GD&ĐT đã tổ chức quán triệt các nội dung của Chỉ thị 05 tới toàn thể cán bộ, giáo viên và học sinh, sinh viên trong cả nước...
            ...
            <!-- begin tin tức mới nhất -->
                ...
                <div class="block_left">
                    <h2>Các liên kết</h2>
                    <div id="module21" class="ModuleWrapper" modulerootid="5932330"><aside class="widget link-icons clearfix"> <p class="post-image"> <a href="http://hocvalamtheobac.vn/" title="Học và làm theo Bác" target="_blank">
...
<!-- begin footer -->
    <section>
      ...
      <script src="bootstrap-4.4.1/dist/js/bootstrap.bundle.min.js" integrity="sha384-6khuMg9gaYr5AxOqhkVIODVIvm9ynTT5J4V1cfthmT+emCG6yVmEZsRHdxlotUnm" crossorigin="anonymous"></script></body>
